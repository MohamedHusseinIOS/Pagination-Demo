...
//
//  Created by Mohamed Hussien on 31/08/2019.
...
class DataTests: XCTestCase {
    ...
    func testStorage() {
        ...
        // When
        do {
            try StorageManager.shared.saveData(data: givenRepos, for: .Repos)
        } catch let error {
    ...
    func testDataManager(){
        ...
        // When
        DataManager.shared.getRepositories(page: 1, limit: 15) { (response) in
            // Then
            switch response {
